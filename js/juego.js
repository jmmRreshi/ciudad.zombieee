...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_horizontal.png', 490, 420, 30, 30, 1),
    ...
    new Obstaculo("imagenes/bache.png", 180, 270, 30, 30, 1),
    new Obstaculo("imagenes/bache.png", 300, 490, 30, 30, 1),
    new Obstaculo("imagenes/bache.png", 510, 120, 30, 30, 1),
    new Obstaculo("imagenes/bache.png", 490, 270, 30, 30, 1),
  ...
  enemigos: [
  new ZombieCaminante ("imagenes/zombie1.png", 500, 300, 10, 10, 1, new RangoDeMovimiento(0,0,961,577)),
  new ZombieCaminante ("imagenes/zombie1.png", 400, 200, 10, 10, 1, new RangoDeMovimiento(0,0,961,577) ),
  new ZombieCaminante ("imagenes/zombie1.png", 600, 20, 10, 10, 1, new RangoDeMovimiento(0,0,961,577) ),
  new ZombieCaminante ("imagenes/zombie2.png", 100, 300, 10, 10, 1, new RangoDeMovimiento(0,0,961,577) ),
  new ZombieCaminante ("imagenes/zombie2.png", 344, 300, 10, 10, 1, new RangoDeMovimiento(0,0,961,577) ),
  new ZombieCaminante ("imagenes/zombie3.png", 600, 250, 10, 10, 1, new RangoDeMovimiento(0,0,961,577) ),

  new ZombieConductor ("imagenes/tren_vertical.png", 644, 40, 30, 90, 5,new RangoDeMovimiento(0,0,961,577),"v"),
  new ZombieConductor ("imagenes/tren_vertical.png", 678, 220, 30, 90, 5, new RangoDeMovimiento(0,0,961,577), "v"),
  new ZombieConductor ("imagenes/tren_horizontal.png", 400, 322, 90, 30, 5, new RangoDeMovimiento(0,0,961,577), "h")
...
document.addEventListener('keydown', function(e) {
  ...
  Juego.capturarMovimiento(teclasPermitidas[e.keyCode]);
});
